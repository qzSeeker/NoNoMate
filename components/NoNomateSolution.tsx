...
const NoNomateSolution = () => {
  const features: Feature[] = [
    {
      number: 1,
      badge: "Matching That Actually Works",
      headline: "We look beyond resumes",
      bodyCopy: "Instead of filtering by college names, we focus on skills. Profiles highlight projects, GitHub, and real work — not just PDFs.",
      icon: (
    ...
    },
    {
      ...
      headline: "Startups are reviewed before approval",
      bodyCopy: "We manually review startups before allowing them to post. Incomplete, unclear, or suspicious listings don’t make it through.",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      headline: "Every application improves your profile",
      bodyCopy: "Even if you’re not selected, your profile gets better. We help you understand what works and what doesn’t over time.",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    },
    {
      ...
      headline: "Learn while you apply",
      bodyCopy: "We’re building practical resources to help you grow —from resume clarity to real-world expectations.",
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-2xl md:text-3xl font-bold text-text-green mb-6">
            How NoNoMate works{" "}
            <span className=" mt-2 bg-gradient-to-r from-text-green to-text-light_green bg-clip-text text-transparent leading-tight">
              {`(and why it’s different)`}
            </span>
          </h1>
          <p className="text-lg md:text-xl text-text-light_green mt-6 max-w-3xl mx-auto">
            A slower, more honest approach to internships{' '}
            <span className="font-bold text-text-green">built for students and early-stage startups.</span>
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-gradient-to-r from-text-green to-text-light_green rounded-2xl p-8 shadow-2xl shadow-text-light_green/20">
            ...
            <p className="text-background-light/90 mb-6 max-w-2xl">
              Create a profile. Choose your role. Get verified.
            </p>
