    ...
    <div className="min-h-screen py-20 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-text-light_green font-medium">
        ...
        <div className="mt-12 grid grid-cols-3 gap-6 text-center">
          <div className="bg-background-light rounded-xl p-6 border border-text-light_green/20">
            <div className="text-3xl font-bold text-text-green mb-2">3,800+</div>
            <div className="text-sm text-text-light_green">Active Students</div>
          </div>
          <div className="bg-background-light rounded-xl p-6 border border-text-light_green/20">
            <div className="text-3xl font-bold text-text-green mb-2">500+</div>
            <div className="text-sm text-text-light_green">Vetted Startups</div>
          </div>
          <div className="bg-background-light rounded-xl p-6 border border-text-light_green/20">
            <div className="text-3xl font-bold text-text-green mb-2">₹15k</div>
